...
16.1. inmatriculare/inregistrare – operatiunea administrativa prin care se atesta ca un vehicul poate circula pe drumurile publice. Dovada atestarii inmatricularii/inregistrarii este certificatul de inmatriculare/inregistrare si numarul de inmatriculare/inregistrare atribuit;
...
40. zona rezidentiala – perimetrul dintr-o localitate unde se aplica reguli speciale de circulatie, avand intrarile si iesirile semnalizate in conformitate cu prevederile legale.`,
    ...
    {
        title: 'CAPITOLUL II: Vehiculele',
        body: `SECTIUNEA 1: Conditiile privind circulatia vehiculelor si controlul acestora
Art. 7
...
`,
    ...
    {
        title: 'CAPITOLUL III: Conducatorii de vehicule',
        body: `SECTIUNEA 1: Dispozitii generale
Art. 20
...
(52)Eliberarea unui nou permis de conducere cu o noua valabilitate administrativa se realizeaza la expirarea valabilitatii documentului, dupa efectuarea examinarii medicale prevazute la art. 22.
(53)In cazurile prevazute la alin. (51) si (52), eliberarea permiselor de conducere respective se realizeaza fara sustinerea unui nou examen, in conditiile stabilite prin ordin al ministrului administratiei si internelor, care se publica in Monitorul Oficial al Romaniei, Partea I.
...
`,
    ...
    {
        title: 'CAPITOLUL IV: Semnalizarea rutiera',
        body: `Art. 29
...
`,
    ...
    {
        title: 'CAPITOLUL V: Reguli de circulatie',
        body: `SECTIUNEA 1: Obligatiile participantilor la trafic
Art. 35
...
(3) Conducatorilor de vehicule le este interzisa folosirea telefoanelor mobile atunci cand acestia se afla in timpul mersului, cu exceptia celor prevazute cu dispozitive tip A«maini libereA».
...
Proprietarul sau detinatorul mandatat al unui vehicul este obligat sa comunice politiei rutiere, la cererea acesteia si in termenul solicitat, identitatea persoanei careia i-a incredintat vehiculul pentru a fi condus pe drumurile publice.A»

Art. 40

Regulile de circulatie pe drumurile publice aplicabile autovehiculelor destinate transporturilor de marfuri, celor cu mase sau cu dimensiuni de gabarit depasite ori care transporta marfuri sau produse periculoase se stabilesc prin regulament, in conformitate cu reglementarile in vigoare.
...
(1) Conducatorului de autovehicul sau tramvai, instructorului auto atestat care se afla in procesul de instruire practica a unei persoane pentru obtinerea permisului de conducere, precum si examinatorului autoritatii competente in timpul desfasurarii probelor practice ale examenului pentru obtinerea permisului de conducere sau pentru oricare dintre categoriile ori subcategoriile acestuia, implicati intr-un accident de circulatie, le este interzis consumul de alcool sau de substante ori produse stupefiante sau medicamente cu efecte similare acestora dupa producerea evenimentului si pana la testarea concentratiei alcoolului in aerul expirat sau recoltarea probelor biologice.
...
(6) Autovehiculele inmatriculate in statele care nu sunt semnatare ale Conventiei asupra circulatiei rutiere, prevazuta la alin. (2), sunt obligate sa poarte in partea din spate semnul distinctiv al statului care a efectuat inmatricularea.
Art. 83
...
`,
    ...
    {
        title: 'CAPITOLUL VI: Infractiuni si pedepse',
        body: `Art. 84
...
`,
    ...
    {
        title: 'CAPITOLUL VII: Raspunderea contraventionala',
        body: `Art. 95
...
`,
    ...
    {
        title: 'CAPITOLUL VIII: Cai de atac impotriva procesului-verbal de constatare a contraventiei',
        body: `Art. 118
...
`,
    ...
    {
        title: 'CAPITOLUL IX: Atributii ale unor ministere si ale altor autoritati ale administratiei publice',
        body: `Art. 122
...
q)elaboreaza, in conditiile legii, norme privind evaluarea capacitatilor psihologice solicitate in activitatea de conducere a autovehiculelor sau tramvaielor.
Art. 123
...
`,
    ...
    {
        title: 'CAPITOLUL X: Dispozitii finale',
        body: `Art. 131
...
p)categoria Tr: tractor, masini si utilaje autopropulsate agricole, forestiere sau pentru lucrari;
